...
engine = create_engine(
     f'oracle+oracledb://IASETI:AIS3t1_2o24@172.35.2.104:1521/?service_name=SETIMN',
...
def main():
    query= """select * from DBMONITOR.VW_TABLERO_CIERRE
                where hpbfini > SYSDATE - 10
                and hpbproc like 'PRRCO%'
                """
